...
import { getOriginalCoverUrl } from '../services/api';
...
export const HeroCarousel: React.FC<HeroCarouselProps> = ({ data }) => {
  ...
  // Use high res cover for hero
  const coverFileName = (mangadex.relationships.find(r => r.type === 'cover_art')?.attributes as any)?.fileName;
